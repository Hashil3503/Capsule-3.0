...
@Database(entities = {Prescription.class, Medication.class, Prescription_View.class, MedicineTable.class, MedicineName.class, DefaultAlarmSet.class, MedicineDex.class}, version = 1)
...
public abstract class DB extends RoomDatabase {
    ...
    public abstract MedicineDexDao medicineDexDao();
